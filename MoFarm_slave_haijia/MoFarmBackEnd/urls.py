...
from .slave_config import local_slave as local_slave
from .views_project import run_project_slave
import threading

local_slave.login()
# local_slave.update_state_all()
# local_slave.update_alive()
t = threading.Thread(target=local_slave.keep, args=())
t.isDaemon = True
t.start()
...
urlpatterns = [
    ...
    # 训练节点管理, modified by zhj, 2022-5-11
    path('Project/run_project_slave', run_project_slave),
