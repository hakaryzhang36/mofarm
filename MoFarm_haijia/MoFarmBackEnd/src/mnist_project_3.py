...
if __name__ == '__main__':
	...
	config = {}
	data_source_1 = DataSource_MNIST("mnist_project_3",config)
	config = {'layer': 3, 'learning_rate': 0.01, 'model': 'feature_extractor_1.pth', 'running': ''}
	feature_extractor_1 = FeatureExtractor_MNIST("mnist_project_3",config)
	config = {'layer': 3, 'learning_rate': 0.01, 'epoch': 5, 'model': 'classifier_1.pth', 'runing': 'tratin'}
	classifier_1 = Classifier_MNIST("mnist_project_3",config)
